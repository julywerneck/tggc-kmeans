...
public class Kmeans {
    private Grafo.Graph grafo;
    private int kCentros;
    private int[][] costMatrix;
    private long startTime;
    static public long TIMEOUT = 3600000;

    public Kmeans(Grafo.Graph grafo, int kCentros) {
        this.grafo = grafo;
    ...
    public HashMap<Integer, ArrayList<Integer>> distributeNodesToCenters(ArrayList<Integer> centers) {
        HashMap<Integer, ArrayList<Integer>> distributedNodes = new HashMap<Integer, ArrayList<Integer>>(
                centers.size());
    ...
    public HashMap<Integer, ArrayList<Integer>> getDistancesToCenters(
            HashMap<Integer, ArrayList<Integer>> distributedNodes) {
        HashMap<Integer, ArrayList<Integer>> distances = new HashMap<Integer, ArrayList<Integer>>(
                distributedNodes.size());
